---
title: 
   Summary ICS report of presenting complaints in primary care that could be addressed through Personalised Care
...
To support a learning health system approach for your ICS, ORCHID has prepared the following report to provide an overview of individuals presenting to GP practices (all of which are members of the RCGP Research Surveillance Centre) within your ICS for the last quarter of the 2019-2020 financial year (i.e. 2019 Q4) and four quarters of the 2020-2021 financial year (i.e. 2020 Q1-Q4). Reference data is also presented for the national average.  
...
\center{
Data source: Oxford-RCGP Clinical Informatics Digital Hub (ORCHID) (https://orchid.phc.ox.ac.uk/) 
}
\center{
...
```{r socialneed-mentalhealth}
   ...
   ggplot(df2, aes(x=qtr, y=value, fill=variable)) +
      ...
      #scale_fill_manual(labels = c(ics, "National"),values = barchartcolors)+
